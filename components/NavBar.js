  ...
  return (
    <div>
      <nav className="flex justify-between items-center">
        ...
        <div className="md:font-outfit md:w-3/5 md:flex md:justify-between hidden">
          <div className="w-4/5">
            <label className="relative block">
              ...
              <input
                class="placeholder:text-black block h-12 bg-white w-full border border-slate-300  py-2 pl-9 pr-3 shadow-sm focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 sm:text-sm"
                placeholder="Search"
                type="text"
                name="search"
              />
